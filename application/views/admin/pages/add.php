    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="form-group">
                ...
                <div class="col-lg-7">
                    <?php echo form_dropdown('template', array('page' => 'Page', 'news' => 'News', 'homepage' => 'Homepage','service' => 'Service','galery' => 'Galery', 'news' => 'News', 'promo' => 'Promo'), $this->input->post('template') ? $this->input->post('template') : '', 'class=form-control'); ?>
                </div>
            </div>
            <div class="form-group">
